    ...
    >
      <section className="page__section">
        ...
        <p>
          ...
          about creating robust user-centric applications with an eye for detail
          and a focus on scalability and flexibility. Most recently engaged as a
          front-end leaning, full-stack software engineer utilizing JavaScript,
          including Node, Express, React, and Redux, and other technologies.
        </p>
